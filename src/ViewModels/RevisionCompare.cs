...
namespace SourceGit.ViewModels
{
    public class RevisionCompare : ObservableObject, IDisposable
    {
        ...
        {
            var patch = await Commands.SaveChangesAsPatch.ProcessRevisionCompareChangesToStringAsync(_repo.FullPath, changes ?? _changes, GetSHA(_startPoint), GetSHA(_endPoint));
            if (patch == null)
                return;
